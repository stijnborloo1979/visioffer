...
(function (global) {
  ...
  function injectMenuItem() {
    ...
    var iv = setInterval(function () {
      ...
      /* Zoek het Geavanceerd dropdown-menu via exact id */
      var menu = document.getElementById("adv-menu");
      if (!menu) return;
      if (menu.querySelector(".cat-menu-item")) { clearInterval(iv); return; }
      ...
      btn.onclick = function (e) {
        e.stopPropagation();
        /* Sluit het menu via class toggle (niet via inline style!) */
        menu.classList.remove("open");
        if (typeof global.closeAdvMenu === "function") global.closeAdvMenu();
        global.openCatalog();
      };
